...
with right_col:
    ...
    if st.session_state.firstround:
        ...
        if st.session_state.places_result:
            ...
            full_prompt += "No recommended places available.\n\n"
...
Do not include JSON or code blocks. Do not explain the itinerary. Just output it directly.\n"""
        ...
        if user_input:
            ...
            full_prompt += """Please generate a refined detailed travel itinerary in **Markdown format** following the previous format, incorporating the above feedback.\n"""
